...
document.write("Fecha de atención: " + fecha.toLocaleDateString() + "<br><br>");


let paciente = prompt("Ingrese el nombre del paciente:");
let regimen = prompt("Ingrese el régimen del paciente (Contributivo o Subsidiado):");
...
if (
    ...
    if (regimen.toLowerCase() == "subsidiado") {
    ...
    document.write("Régimen: " + regimen + "<br><br>");
